...
namespace Harman.Web.Controllers
{
    public class VendedorsController : Controller
    {
        ...
        public VendedorsController(DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("VendedorID,CodigoVendedor,DescripcionVendedor,SellerCommissionPercent,SellerDiscountValue")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VendedorID,CodigoVendedor,DescripcionVendedor,SellerCommissionPercent,SellerDiscountValue")] Vendedor vendedor)
        {
