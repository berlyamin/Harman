...
namespace Harman.Web.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MarcaID,CodigoMArca,NombreMarca")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MarcaID,CodigoMArca,NombreMarca")] Marca marca)
        {
            if (id != marca.MarcaID)
            {
                return NotFound();
