...
namespace Harman.Web.Controllers
{
    public class EstadoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EstadoID,StatusCode,StatusName")] Estado estado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EstadoID,StatusCode,StatusName")] Estado estado)
        {
